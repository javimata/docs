...
<ReadMore>Ver la [referencia de configuración de tablas](/es/guides/integrations-guide/db/#table-configuration-reference) para una referencia completa sobre las opciones de tablas.</ReadMore>
...
<ReadMore>Ver la [tabla de referencia de columnas](/es/guides/integrations-guide/db/#table-configuration-reference) para más detalles.</ReadMore>
